<?php get_header(); ?>
				...
				<div class="row">
					<div class="resume_container">
						...
						<div class="col-md-6 col-sm-6 right">
							<h3><?php
								$idObj = get_category_by_slug('c_proj');
								$id = $idObj->term_id;
								echo get_cat_name($id) ?></h3>
	...
	<section id="portfolio" class="s_portfolio bg_dark">
		<div class="section_header">
			<h2><?php
				$idObj = get_category_by_slug('s_uslugi');
				$id = $idObj->term_id;
				echo get_cat_name($id);
				?></h2>
			<div class="s_descr_wrap">
				...
				<div class="row">
					<div class="filter_div controls">
						<ul>
							...
							<li class="filter" data-filter=".it-cons">ИТ-консалтинг</li>
							<li class="filter" data-filter=".security">Информационная безопасность</li>
							<li class="filter" data-filter=".service">Сервисная программа</li>
						</ul>
					</div>
		...
		<div class="section_content">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6">
						<form action="http://formspree.io/support@tsvetkov.pro" class="main_form" novalidate target="_blank" method="post">
